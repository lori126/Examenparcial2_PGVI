...
class FormUi(ft.UserControl):
 ...
 # Definición de los campos de entrada para los datos
        ...
        self.age = ft.TextField(label="Edad", border_color= "cyan", 
                                ...
                                max_length =2)
        self.email =ft.TextField(label="Correo", border_color= "cyan")
      ...
      # Definición de la tabla que muestra los contactos
        self.data_table =  ft.DataTable(
                            ...
                            data_row_color = { ft.MaterialState.SELECTED: "cyan", ft.MaterialState.PRESSED: "white"},
                            border_radius=8,
                            show_checkbox_column = True,
                            columns=[
                                ft.DataColumn(ft.Text("Nombre", color="cyan", weight = "bold")),
                                ft.DataColumn(ft.Text("Edad", color="cyan", weight = "bold")),
                                ft.DataColumn(ft.Text("Correo", color="cyan", weight = "bold"), numeric=True),
                                ft.DataColumn(ft.Text("Telefono", color="cyan", weight = "bold"), numeric=True ),
                            ],
                        )        
                    ...
                    ft.Container(
                        content= ft.Row(
                            ...
                            ft.TextButton(text="Guardar",
                                        icon = ft.icons.SAVE,
                                        icon_color= "white",
                                        style= ft.ButtonStyle(color = "white",  bgcolor ="cyan"),
